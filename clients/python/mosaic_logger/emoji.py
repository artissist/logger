...
class EmojiResolver:
    ...
    DEFAULT_MAPPINGS: Dict[LogEvent, EmojiMapping] = {
        ...
        LogEvent.DATABASE_OPERATION: EmojiMapping("💾", "Database queries and operations"),
        LogEvent.USER_AUTH: EmojiMapping("👤", "User authentication and authorization"),
        LogEvent.PROJECT_LIFECYCLE: EmojiMapping("📁", "Project creation, updates, and status changes"),
        LogEvent.PERFORMANCE_METRIC: EmojiMapping("⚡", "Performance measurements and metrics"),
        LogEvent.WARNING_ISSUED: EmojiMapping("⚠️", "Warning conditions and alerts"),
        LogEvent.SECURITY_EVENT: EmojiMapping("🔐", "Security-related events and violations"),
        LogEvent.AI_INFERENCE: EmojiMapping("🧠", "AI model inference and processing"),
        LogEvent.CONVERSATION_EVENT: EmojiMapping("💬", "Conversation logging and transcript events"),
        LogEvent.AGENT_LIFECYCLE: EmojiMapping("🤖", "Agent creation, updates, and task management"),
        LogEvent.TASK_EXECUTION: EmojiMapping("⚙️", "Task execution and workflow processing"),
        LogEvent.BUSINESS_METRIC: EmojiMapping("📊", "Business KPIs and analytics"),
        LogEvent.INSPIRATION_EVENT: EmojiMapping("💡", "Inspiration capture and management"),
        LogEvent.WORKFLOW_EVENT: EmojiMapping("🔀", "Workflow state transitions and automation"),
        LogEvent.INTEGRATION_EVENT: EmojiMapping("🔌", "Third-party integrations and API calls"),
        LogEvent.CONFIGURATION_CHANGE: EmojiMapping("🔧", "Configuration updates and settings"),
        ...
        LogEvent.MAINTENANCE_EVENT: EmojiMapping("🔨", "System maintenance and updates"),
        LogEvent.USER_INTERACTION: EmojiMapping("👆", "User interface interactions and clicks"),
        LogEvent.DATA_PROCESSING: EmojiMapping("🔄", "Data processing and transformation"),
    ...
    def get_emoji(self, event: Optional[LogEvent], custom_event: Optional[str] = None) -> Optional[str]:
        """
    ...
    def get_description(self, event: Optional[LogEvent], custom_event: Optional[str] = None) -> Optional[str]:
        """
