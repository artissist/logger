...
export class ContextManager {
     ...
     */
    static mergeContexts(context1: LoggingContext, context2: Partial<LoggingContext>): LoggingContext {
    ...
    static sanitizeContext(context: LoggingContext): LoggingContext {
        ...
        if (context.parentCorrelationId && ContextManager.isValidCorrelationId(context.parentCorrelationId)) {
