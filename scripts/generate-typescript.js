...
let output = `// SPDX-License-Identifier: AGPL-3.0-or-later
...
console.log(`📊 Generated ${Object.keys(model.shapes).filter(name => name.startsWith('artissist.logging#')).length} types`);
if (emojiMappings) {
  console.log(`🎨 Generated standardized emoji mappings`);
}
